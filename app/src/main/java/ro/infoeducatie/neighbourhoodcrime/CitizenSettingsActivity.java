...
public class CitizenSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCitizenDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Citizens").child(userID);
    ...
    private void getUserInfo() {
        mCitizenDatabase.addValueEventListener(new ValueEventListener() {
            @Override
